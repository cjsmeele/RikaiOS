...
namespace Interrupt::Idt {
    ...
    void init() {
        ...
        //
        // Note: Entry 0xca will be used for syscalls, thus we mark it as
        // user-callable using the U macro.
        // Trying to call any other interrupt from user-mode will result in a
        // GPF exception and kill the process.

#define I(n) table[n] = make_entry(Handler::isr_##n);
#define U(n) table[n] = make_entry(Handler::isr_##n, true);
        ...
        I(0xc8) I(0xc9) U(0xca) I(0xcb) I(0xcc) I(0xcd) I(0xce) I(0xcf)
